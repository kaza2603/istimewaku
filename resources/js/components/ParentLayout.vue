...
<template>
    <div class="min-h-screen bg-gray-100">
        ...
        >
            <Sheet v-model:open="isSidebarOpen">
                ...
                >
                    <div id="nav-description" class="sr-only">
                        Menu navigasi untuk mengakses bahagian-bahagian panel
                        ibu bapa
                    </div>
                        ...
                        <div>
                            ...
                            >
                                <SheetTitle class="sr-only"
                                    >Panel Ibu Bapa IstimewaKu</SheetTitle
                                >
                                <IstimewaKuLogo
                                    class="h-8 w-full justify-center"
                                />
                                <p
                                    class="text-sm font-semibold text-center text-gray-500"
                                >
                                    Panel Ibu Bapa
                                </p>
                            </div>
            ...
            <div class="ml-4 text-lg font-semibold">Panel Ibu Bapa</div>
        </div>
        ...
        <!-- Main Content -->
        <div class="lg:pl-64">
            <main class="pt-24 lg:pt-6 px-4 sm:px-6 lg:px-8">
                <slot />
            </main>
        </div>
    </div>
